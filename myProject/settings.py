...
SECRET_KEY = 'django-insecure-sm=z%8=5igs=1l9n9(ei_%5*sk#z-1htbjs-%!v9&mq=co9y=*'
...
ALLOWED_HOSTS = [
    ...
    "katalystaichatbot-production.up.railway.app",
]

# CSRF trusted origins (must include your Railway URL + any custom domain)
CSRF_TRUSTED_ORIGINS = [
    "https://katalystaichatbot-production.up.railway.app",
]
